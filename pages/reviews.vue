...
const reviews = ref([
  {
    ...
    eventType: 'Свадьба',
    rating: 5,
    text: 'Невероятное выступление! Гости до сих пор вспоминают этот вечер. Стерео-Хит создали такую атмосферу, что все танцевали до утра. Очень профессионально и душевно.',
    date: 'Сентябрь 2023',
  ...
  },
  {
    ...
    eventType: 'Свадьба',
    rating: 5,
    text: 'Лучший выбор для нашей свадьбы! Стерео-Хит сделали наш день особенным. Все гости до сих пор говорят, что это была лучшая свадьба.',
    date: 'Август 2023',
  ...
  },
  {
    ...
    eventType: 'Свадьба',
    rating: 5,
    text: 'Музыкальное сопровождение церемонии было просто идеальным. Стерео-Хит помогли сделать наш день незабываемым.',
    date: 'Май 2023',
