...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Галерея кавер группы СтереоХит. Фото и видео с корпоративов, свадеб, дней рождения. Видео отзывы клиентов и портфолио выступлений.'
    }
  ]
})
...
const galleryItems = ref([
  // Корпоративы
  {
    ...
    description: 'Выступление на корпоративе IT-компании',
  ...
  },
  {
    id: 2,
    type: 'video',
    title: 'Корпоратив банка',
    description: 'Музыкальная программа для сотрудников банка',
    category: 'Корпоративы',
    date: 'Ноябрь 2023'
  },
  {
  ...
  // Свадьбы
  {
    ...
    description: 'Первый танец молодоженов',
    category: 'Свадьбы',
    date: 'Сентябрь 2023'
  },
  {
  ...
  },
  {
    ...
    description: 'Музыкальное сопровождение церемонии',
    category: 'Свадьбы',
    date: 'Июль 2023'
  },
  ...
  // Дни рождения
  {
    ...
    type: 'photo',
    title: 'Юбилей 50 лет',
    description: 'Празднование юбилея в ресторане',
  ...
  },
  {
    ...
    description: 'Вечеринка в стиле 80х',
    category: 'Дни рождения',
    date: 'Май 2023'
  },
  {
    ...
    description: 'Музыкальная программа для детей',
    category: 'Дни рождения',
    date: 'Апрель 2023'
  },
  ...
  // Дополнительные фото
  {
    ...
    type: 'photo',
    title: 'За кулисами',
    description: 'Подготовка к выступлению',
    category: 'Фото',
    date: 'Март 2023'
  },
  {
    ...
    type: 'photo',
    title: 'Репетиция',
    description: 'Работа над новым репертуаром',
    category: 'Фото',
    date: 'Февраль 2023'
  },
  {
    ...
    description: 'Рассказ о творческом процессе',
    category: 'Видео',
    date: 'Январь 2023'
  },
  ...
  // Еще больше контента
  {
    ...
    description: 'Выступление в офисе компании',
    category: 'Корпоративы',
    date: 'Декабрь 2022'
  },
  {
    id: 14,
    type: 'video',
    title: 'Свадьба на природе',
    description: 'Романтичная свадьба на открытом воздухе',
    category: 'Свадьбы',
    date: 'Ноябрь 2022'
  },
  {
    ...
    description: 'Интимное празднование',
    category: 'Дни рождения',
    date: 'Октябрь 2022'
  },
  {
    id: 16,
    type: 'video',
    title: 'Корпоратив в ресторане',
    description: 'Гала-ужин с музыкальной программой',
    category: 'Корпоративы',
    date: 'Сентябрь 2022'
  },
  {
    ...
    description: 'Фото с молодоженами',
    category: 'Свадьбы',
    date: 'Август 2022'
  },
  {
    ...
    description: 'Детский праздник с музыкой',
    category: 'Дни рождения',
    date: 'Июль 2022'
  },
])
